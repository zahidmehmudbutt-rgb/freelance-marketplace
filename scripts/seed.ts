...
const SELLERS = [
  {
    email: "ahmad@brellis.test", username: "ahmaddev", full_name: "Ahmad Raza",
  ...
  {
    email: "sara@brellis.test", username: "saradesigns", full_name: "Sara Khan",
  ...
  {
    email: "noor@brellis.test", username: "nocodenoor", full_name: "Noor Fatima",
  ...
  {
    email: "ali@brellis.test", username: "aibuilder_ali", full_name: "Ali Hassan",
  ...
  {
    email: "usman@brellis.test", username: "mobilemaster_usman", full_name: "Usman Malik",
...
async function main() {
  ...
  console.log("  ahmad@brellis.test");
